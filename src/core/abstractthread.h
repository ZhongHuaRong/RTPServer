...
public:
	 ...
	 * 子类指针
	 */
	static void ThreadCallBackFunction(void *object);
protected:
	/**
	 * @brief start_thread
	 * 启动线程
...
inline void AbstractThread::on_thread_run()												{		}
inline void AbstractThread::on_thread_pause()											{		}
